...
window.Admin = function Admin({ navigateTo }) {
  ...
  if (!auth.user) {
    return (
      <div className="min-h-screen bg-[#0f1128] text-[#f0f0f8] font-sans animate-fade-in flex items-center justify-center px-6 py-24">
        <div className="max-w-md w-full bg-[#0c0d23] border border-white/10 rounded-2xl p-8 md:p-10 shadow-2xl text-center">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-[#9296c8]/10 mb-6 border border-[#9296c8]/30">
            <svg className="w-8 h-8 text-[#9296c8]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  // ----------------------------------------------------
  return (
    <div className="min-h-screen bg-[#0f1128] text-[#f0f0f8] font-sans animate-fade-in pb-24">
      {/* Top Admin Header */}
      <div className="bg-[#0c0d23] border-b border-white/10 sticky top-0 z-30 shadow-md">
                  ...
                  <div className="flex gap-6 items-start flex-1">
                    ...
                    <div className="space-y-2 flex-1">
                      ...
                      <div className="flex items-center gap-4 text-xs text-slate-400 pt-2">
                        ...
                        {evt.posterUrl && <span className="text-emerald-400 font-medium">🖼️ Poster Uploaded</span>}
                      </div>
                    </div>
                  </div>
