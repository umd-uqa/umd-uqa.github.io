        ...
        <div className="mb-14">
          ...
          <div className="space-y-0">
            {events.map((event, index) => (
              <div key={event.id || index} className="grid grid-cols-1 md:grid-cols-[140px_1fr] gap-8 md:gap-12 py-12 border-t border-white/10 first:border-t-0 last:border-b last:border-white/10 relative group">

                {/* Date Column: Scaled for the 1400px container */}
                <div className="text-left pt-1 flex md:flex-col items-baseline md:items-start gap-3 md:gap-0">
                  ...
                  {event.year && (
                    <div className="font-['Raleway'] text-[14px] text-slate-400 font-light mt-1">
                      {event.year}
                    </div>
                  )}
                </div>
                ...
                <div className="space-y-3">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                      ...
                      {event.subtitle && (
                        <div className="text-[18px] text-[#a8abdb] italic mt-1">
                          {event.subtitle}
                        </div>
                      )}
                    </div>
                  ...
                  <p className="text-[20px] text-[#f0f0f8]/80 leading-[1.9] mb-6 pt-2">
                    {event.description}
                  </p>
                  ...
                  {/* Poster Thumbnail & Action Buttons */}
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 pt-6 flex-wrap">
                    {/* Action Links */}
                    ...
                    {event.posterUrl && (
                      ...
                      >
                        ...
                        <span>View Official Flyer / Poster →</span>
                      </button>
                    )}
                  </div>
                </div>
